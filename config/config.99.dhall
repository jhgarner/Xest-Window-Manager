...
let fontLoc = "/nix/store/1sldx0ry67bvr6nk7pblqdyl2yrr6lh1-fira-code-2/share/fonts/opentype/FiraCode-Retina.otf"
...
in {
  ...
  keyBindings =
    newKey Insert
      [ {key = "Alt_L", actions = [Action.ChangeModeTo Normal]}
      ]
    #
    newKey Normal (
