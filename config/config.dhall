...
in {
  ...
  keyBindings = [
    ...
    {key = "n", mode = Normal, actions = [Action.Insert Tiler.Horizontal], exitActions = [] : List Action},
    ...
    {key = "s", mode = Normal, actions = [Action.ZoomOutMonitor, Action.ZoomOutInput, Action.MakeSpecial, Action.ZoomInInput, Action.ZoomMonitorToInput], exitActions = [] : List Action},
    {key = "s", mode = NormalS, actions = [Action.MakeSpecial], exitActions = [] : List Action},
